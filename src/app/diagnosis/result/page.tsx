        ...
        <div className="text-center text-sm">
          ...
          {saveStatus === "anonymous" && (
            <div className="rounded-lg border border-neutral-200 bg-white p-4">
              ...
              <Link
                href="/login"
                className="mt-3 flex items-center justify-center gap-2 rounded-lg border border-neutral-300 bg-white px-4 py-2.5 text-sm font-medium text-neutral-700 transition-colors hover:bg-neutral-50"
              >
